...
function DiffPane({ side, rows }: DiffPaneProps) {
  ...
  return (
    <section
      className="flex min-h-80 min-w-0 flex-col overflow-hidden border-slate-800 bg-[var(--workspace-code-bg)] first:border-b xl:min-h-[30rem] xl:first:border-r xl:first:border-b-0"
